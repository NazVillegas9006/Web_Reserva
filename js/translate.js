const translations = {
  en: {
    ...
    descripcion1: "Our butterfly garden in La Fortuna de San Carlos is one of the newest attractions in the Arenal area, offering a unique experience in contact with tropical nature.",
  ...
  es: {
    ...
    descripcion1: "Nuestro mariposario ubicado en La Fortuna de San Carlos es una de las atracciones más recientes en la región de Arenal, ofreciendo una experiencia única en contacto con la naturaleza tropical.",
